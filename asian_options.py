...
class asian:
    ...
    def from_csv(cls, csv_path, K, r, T, option_type, N=1000, M=10000,
        ...
        """
        Create an asian option pricer instance from a CSV file of historical stock data.
        ...
        ----------
        cls : type
            The class itself, used to create a new instance.
        csv_path : str
        ...
        -------
        asian
            An instance of the asian class, configured with parameters derived from the data.
